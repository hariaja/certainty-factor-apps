...
@section('hero-title', trans('Ubah Kata Sandi'))
@section('hero-subtitle', trans('Mengubah Kata Sandi anda secara berkala dapat membantu untuk mengamankan akun anda.'))
@section('content')
<div class="block block-rounded">
  ...
  <div class="block-content">
    <form action="{{ url('users/users/password') }}" method="POST" onsubmit="return disableSubmitButton()">
      @csrf
